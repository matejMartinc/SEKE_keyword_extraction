...
def run_metrics(match_list, pred_list, tgt_list, score_names, topk_range, type='exact'):
    ...
    for topk in topk_range:
        ...
        if len(pred_list) > cutoff:
            pred_list_k = pred_list[:cutoff]
            match_list_k = match_list[:cutoff]
        else:
            pred_list_k = pred_list
...
def eval(detected_keywords, gold_standard_keywords, remove_docs_with_no_kw=True):
    ...
    for preds, true in zip(detected_keywords, gold_standard_keywords):
        ...
        topk_range = [1, 3, 5, 10, 'k', 'M']

        match_list = get_match_result(true, preds)

        scores = run_metrics(match_list, preds, true, metric_names, topk_range)

        p_et_1 = scores['precision@1']
        r_et_1 = scores['recall@1']
        p_et_3 = scores['precision@3']
        r_et_3 = scores['recall@3']
        ...
        all_p_et_1.append(p_et_1)
        all_r_et_1.append(r_et_1)
        all_p_et_3.append(p_et_3)
        all_r_et_3.append(r_et_3)
    ...
    p_1, r_1, f_1 = macro_averaged_score(all_p_et_1, all_r_et_1)
    print("P@1: ", p_1)
    print("R@1: ", r_1)
    print("F1@1: ", f_1)
    print()
    ...
    p_3, r_3, f_3 = macro_averaged_score(all_p_et_3, all_r_et_3)
    print("P@3: ", p_3)
    print("R@3: ", r_3)
    print("F1@3: ", f_3)
    print()
    ...
    return p_1, r_1, f_1, p_3, r_3, f_3, p_5, r_5, f_5, p_10, r_10, f_10, p_k, r_k, f_k, p_M, r_M, f_M
